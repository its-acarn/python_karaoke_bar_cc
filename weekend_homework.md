...
2. Create a file called ``` run_tests.py ``` and paste the following code into it:
...
3. Create a ``` tests ``` directory and a ``` classes ``` directory.
4. To run the tests in Terminal type
